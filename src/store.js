...
const Store = (() => {
  ...
  const FOOD_DATABASE = [
    ...
    // More Vegetables
    { name: 'Peas (1 cup)', calories: 118, proteins: 8, fats: 0.6, carbs: 21, category: 'vegetable' },
    { name: 'Green Beans (1 cup)', calories: 31, proteins: 1.8, fats: 0.2, carbs: 7, category: 'vegetable' },
    { name: 'Asparagus (1 cup)', calories: 27, proteins: 2.9, fats: 0.2, carbs: 5, category: 'vegetable' },
    { name: 'Cauliflower (1 cup)', calories: 27, proteins: 2.1, fats: 0.3, carbs: 5, category: 'vegetable' },
    { name: 'Zucchini (1 cup)', calories: 21, proteins: 1.5, fats: 0.4, carbs: 4, category: 'vegetable' },
    { name: 'Eggplant (1 cup)', calories: 20, proteins: 0.8, fats: 0.2, carbs: 5, category: 'vegetable' },
    { name: 'Mushroom (1 cup)', calories: 15, proteins: 2.2, fats: 0.2, carbs: 2, category: 'vegetable' },
    { name: 'Onion (1 cup)', calories: 64, proteins: 1.8, fats: 0.2, carbs: 15, category: 'vegetable' },
    { name: 'Potato (1 medium)', calories: 163, proteins: 4.3, fats: 0.2, carbs: 37, category: 'vegetable' },
    { name: 'Lettuce (1 cup)', calories: 5, proteins: 0.5, fats: 0.1, carbs: 1, category: 'vegetable' },
    { name: 'Cabbage (1 cup)', calories: 22, proteins: 1.3, fats: 0.1, carbs: 5, category: 'vegetable' },
    { name: 'Radish (1 cup)', calories: 19, proteins: 0.8, fats: 0.1, carbs: 4, category: 'vegetable' },
    { name: 'Beetroot (1 cup)', calories: 59, proteins: 2.2, fats: 0.2, carbs: 13, category: 'vegetable' },
    { name: 'Turnip (1 cup)', calories: 36, proteins: 1.2, fats: 0.1, carbs: 8, category: 'vegetable' },
    { name: 'Okra (1 cup)', calories: 33, proteins: 1.9, fats: 0.2, carbs: 7, category: 'vegetable' },
    { name: 'Pumpkin (1 cup)', calories: 30, proteins: 1.2, fats: 0.1, carbs: 8, category: 'vegetable' },
    { name: 'Artichoke (1 medium)', calories: 60, proteins: 4.2, fats: 0.2, carbs: 13, category: 'vegetable' },
    { name: 'Leek (1 cup)', calories: 54, proteins: 1.3, fats: 0.3, carbs: 14, category: 'vegetable' },
    { name: 'Celery (1 cup)', calories: 16, proteins: 0.7, fats: 0.2, carbs: 3, category: 'vegetable' },
    { name: 'Fennel (1 cup)', calories: 27, proteins: 1.1, fats: 0.2, carbs: 6, category: 'vegetable' },
    { name: 'Bok Choy (1 cup)', calories: 9, proteins: 1, fats: 0.1, carbs: 1.5, category: 'vegetable' },
    { name: 'Swiss Chard (1 cup)', calories: 7, proteins: 0.6, fats: 0.1, carbs: 1.3, category: 'vegetable' },
    { name: 'Kale (1 cup)', calories: 33, proteins: 2.9, fats: 0.6, carbs: 6, category: 'vegetable' },
    { name: 'Collard Greens (1 cup)', calories: 11, proteins: 1.1, fats: 0.2, carbs: 2, category: 'vegetable' },
    { name: 'Mustard Greens (1 cup)', calories: 15, proteins: 1.5, fats: 0.2, carbs: 3, category: 'vegetable' },
    { name: 'Turnip Greens (1 cup)', calories: 18, proteins: 1.1, fats: 0.2, carbs: 4, category: 'vegetable' },
    { name: 'Watercress (1 cup)', calories: 4, proteins: 0.8, fats: 0, carbs: 0.4, category: 'vegetable' },
    { name: 'Arugula (1 cup)', calories: 5, proteins: 0.5, fats: 0.1, carbs: 0.7, category: 'vegetable' },
    { name: 'Endive (1 cup)', calories: 8, proteins: 0.8, fats: 0.1, carbs: 1.7, category: 'vegetable' },
    { name: 'Chicory (1 cup)', calories: 7, proteins: 0.7, fats: 0.1, carbs: 1.5, category: 'vegetable' },
    { name: 'Jicama (1 cup)', calories: 49, proteins: 0.9, fats: 0.1, carbs: 11, category: 'vegetable' },
    { name: 'Kohlrabi (1 cup)', calories: 36, proteins: 2.3, fats: 0.1, carbs: 8, category: 'vegetable' },
    { name: 'Parsnip (1 cup)', calories: 100, proteins: 1.5, fats: 0.4, carbs: 24, category: 'vegetable' },
    { name: 'Rutabaga (1 cup)', calories: 52, proteins: 1.5, fats: 0.2, carbs: 12, category: 'vegetable' },
    { name: 'Salsify (1 cup)', calories: 93, proteins: 3.8, fats: 0.2, carbs: 21, category: 'vegetable' },
    { name: 'Celeriac (1 cup)', calories: 66, proteins: 2.3, fats: 0.5, carbs: 14, category: 'vegetable' },
    { name: 'Daikon (1 cup)', calories: 21, proteins: 0.7, fats: 0.1, carbs: 5, category: 'vegetable' },
    { name: 'Ginger (1/4 cup)', calories: 19, proteins: 0.4, fats: 0.2, carbs: 4, category: 'vegetable' },
    { name: 'Garlic (1 clove)', calories: 4, proteins: 0.2, fats: 0, carbs: 1, category: 'vegetable' },
    { name: 'Shallot (1 tbsp)', calories: 7, proteins: 0.3, fats: 0, carbs: 1.7, category: 'vegetable' },
    { name: 'Scallion (1 cup)', calories: 32, proteins: 1.8, fats: 0.2, carbs: 7, category: 'vegetable' },
    { name: 'Chives (1 tbsp)', calories: 1, proteins: 0.1, fats: 0, carbs: 0.1, category: 'vegetable' },
    // Protein
    ...
    // More Beverages
    { name: 'Tea (Chai) with Milk & Sugar', calories: 60, proteins: 2, fats: 2, carbs: 10, category: 'drink' },
    { name: 'Masala Chai', calories: 75, proteins: 2.5, fats: 2.5, carbs: 12, category: 'drink' },
    { name: 'Ginger Tea (Adrak Chai)', calories: 65, proteins: 2, fats: 2, carbs: 11, category: 'drink' },
    { name: 'Black Tea', calories: 2, proteins: 0, fats: 0, carbs: 0.5, category: 'drink' },
    { name: 'Lemon Tea', calories: 15, proteins: 0, fats: 0, carbs: 4, category: 'drink' },
    { name: 'Green Tea', calories: 0, proteins: 0, fats: 0, carbs: 0, category: 'drink' },
    { name: 'Filter Coffee (with Milk)', calories: 80, proteins: 3, fats: 3, carbs: 12, category: 'drink' },
    { name: 'Cold Coffee', calories: 180, proteins: 4, fats: 6, carbs: 25, category: 'drink' },
    { name: 'Buttermilk (Chaas)', calories: 40, proteins: 2, fats: 1, carbs: 5, category: 'drink' },
    { name: 'Nimbu Pani (Lemonade)', calories: 45, proteins: 0, fats: 0, carbs: 12, category: 'drink' },
    { name: 'Mango Shake', calories: 220, proteins: 5, fats: 6, carbs: 35, category: 'drink' },
    { name: 'Badam Milk', calories: 150, proteins: 6, fats: 8, carbs: 15, category: 'drink' },
    { name: 'Sugarcane Juice (1 glass)', calories: 120, proteins: 0, fats: 0, carbs: 30, category: 'drink' },
    { name: 'Apple Juice (250ml)', calories: 110, proteins: 0.5, fats: 0.3, carbs: 28, category: 'drink' },
    { name: 'Mango Juice (250ml)', calories: 130, proteins: 1, fats: 0.5, carbs: 32, category: 'drink' },
    { name: 'Pineapple Juice (250ml)', calories: 120, proteins: 1, fats: 0.2, carbs: 30, category: 'drink' },
    { name: 'Sweet Lime Juice (Mosambi)', calories: 90, proteins: 1, fats: 0.2, carbs: 22, category: 'drink' },
    { name: 'Thandai', calories: 200, proteins: 6, fats: 10, carbs: 25, category: 'drink' },
    { name: 'Instant Coffee', calories: 2, proteins: 0.3, fats: 0, carbs: 0, category: 'drink' },
    { name: 'Milk (1 cup)', calories: 150, proteins: 8, fats: 8, carbs: 12, category: 'drink' },
    { name: 'Soy Milk (1 cup)', calories: 100, proteins: 7, fats: 4, carbs: 8, category: 'drink' },
    { name: 'Almond Milk (1 cup)', calories: 40, proteins: 1, fats: 3, carbs: 2, category: 'drink' },
    { name: 'Oat Milk (1 cup)', calories: 120, proteins: 3, fats: 5, carbs: 16, category: 'drink' },
    { name: 'Soda / Cola (330ml)', calories: 140, proteins: 0, fats: 0, carbs: 35, category: 'drink' },
    { name: 'Energy Drink (250ml)', calories: 110, proteins: 0, fats: 0, carbs: 28, category: 'drink' },
    { name: 'Sweet Lassi', calories: 200, proteins: 5, fats: 5, carbs: 35, category: 'drink' },
    { name: 'Salted Lassi', calories: 120, proteins: 5, fats: 5, carbs: 15, category: 'drink' },
    // Fast Food
